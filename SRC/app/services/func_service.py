...
def list_func():
    ...
    try:
        ...
        current_app.logger.error(
            f"Services: Error fetching all funcionarios: {db_error}")
        return None
...
def list_func_id(idd):
    ...
    try:
        ...
        current_app.logger.error(
            f"Services: Error fetching funcionarios idd: {idd} {db_error}")
        return None
...
def register_func(func):
    ...
    try:
        ...
        db.session.rollback()
        current_app.logger.error(
            f"Services: Error registering funcionario: {db_error}")
...
def edit_func(func):
    ...
    try:
        ...
        db.session.rollback()
        current_app.logger.error(
            f"Services: Error editing funcionario: {db_error}")
...
def remove_func(func):
    ...
    try:
        ...
        db.session.rollback()
        current_app.logger.error(
            f"Services: Error removing funcionario: {db_error}")
