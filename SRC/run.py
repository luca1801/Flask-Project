...
from app.views.Funcionarios import (cadastro_func_blueprint, listar_func_blueprint,
                                    editar_func_blueprint, remover_func_blueprint)
from app import app
...
app.register_blueprint(remover_func_blueprint)
